...
function romPacksPage(items: RomPackItem[], overrides: Partial<{ total: number; limit: number; offset: number }> = {}) {
...
describe('ROM Packs tab (/emulators/rom-packs) — list-only, no detail route', () => {
  ...
  it('renders pagination controls and pages forward when total exceeds one page', async () => {
    const SECOND_ROM_PACK_ENTRY: CatalogEntry = { ...ROM_PACK_ENTRY, slug: 'ps2-bios-pack', name: 'PS2 BIOS Pack' }
