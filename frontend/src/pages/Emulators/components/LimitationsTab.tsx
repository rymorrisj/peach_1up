  ...
  return (
    <div className="flex flex-col gap-3">
      {(entry.known_limitations ?? []).map((lim, i) => {
        const {
          title: limTitle,
          severity: limSeverity,
          description: limDescription,
        } = lim as { title: string; severity: string; description: string };
        ...
        return (
          <div
            ...
            style={{ background: severityStyle.background, border: severityStyle.border }}
          >
