      ...
      <div className="grid gap-3.5" style={{ gridTemplateColumns: '1fr 1fr' }}>
        ...
        >
          ...
          {entry.install_type === 'installer' && (
            <div
              style={{ marginTop: 12, paddingTop: 12, borderTop: '1px solid rgb(var(--border))' }}
            >
              <div
                style={{
                  display: 'flex',
            ...
            {emulatorBios.map((bios, i) => (
              <div
                ...
                style={{
                  padding: '14px 18px',
                  borderBottom:
                    i < emulatorBios.length - 1 ? '1px solid rgb(var(--border))' : 'none',
                }}
              >
