...
import LaunchHistorySection from '@/components/launches/LaunchHistory'
...
export default function ItemDetail() {
  ...
  } = useLaunch(item?.id ?? 0, 'library_item', { profileId })
  ...
  return (
    <>
      ...
      <div className="max-w-xl space-y-10">
        ...
        {/* ── Session history ── */}
        {item && <LaunchHistorySection targetId={item.id} targetType="library_item" />}
