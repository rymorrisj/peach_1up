...
describe('StepBios', () => {
  ...
  it('shows the present/required summary once loaded', async () => {
    vi.mocked(apiFetch).mockResolvedValue({
      items: [
        { slug: 'ps1', name: 'PS1 BIOS', platform: 'ps1', bios_path: 'scph.bin', guidance_text: '', guidance_url: '', is_present: true, required: true },
        { slug: 'saturn', name: 'Saturn BIOS', platform: 'saturn', bios_path: 'sat.bin', guidance_text: '', guidance_url: '', is_present: false, required: true },
      ],
      total: 2,
      limit: 200,
      offset: 0,
