...
export const ERA_PLACEHOLDER: Record<string, { bg: string; color: string }> = {
  ...
  win95: {
    bg: 'linear-gradient(155deg, #20281a 0%, #11160c 100%)',
    color: 'rgb(var(--era-win95))',
  },
  win98: {
    bg: 'linear-gradient(155deg, #17202b 0%, #0c1118 100%)',
    color: 'rgb(var(--era-win98))',
  },
  winxp: {
    bg: 'linear-gradient(155deg, #182617 0%, #0e150d 100%)',
    color: 'rgb(var(--era-winxp))',
  },
...
export const ERA_PLACEHOLDER_DEFAULT = {
  bg: 'linear-gradient(155deg, #1c2230 0%, #11141c 100%)',
  color: '#6aa9d6',
};
