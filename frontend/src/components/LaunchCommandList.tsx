  ...
  return (
    <div className="space-y-3">
      <div>
        ...
        <div className="rounded-md border border-neutral-200 bg-surface-2 px-3 py-2 font-mono text-xs text-neutral-700 break-all dark:border-neutral-700 dark:text-neutral-300">
          {preview}
        </div>
      </div>
          ...
          <div key={i} className="flex items-center gap-2">
            <div className="flex flex-col gap-0.5">
              <Button
                ...
                aria-label="Move up"
                className="h-5 w-5 p-0 text-[0.625rem] leading-none"
              >
                ▲
              </Button>
              <Button
